...
function on_btnGetDevices_click( ) {
  ...
  com.fc.JavaScriptDistLib.Connio.connioGetDevices('_dpf_807651864374550548',
   function(devices){
    ...
    // Block#: 15
    com.fc.JavaScriptDistLib.MapContainer.setLocationForMarker(DeviceLocationMarker, locStation);// Block#: 18
...
// Block#: 20
 function on_marker_in_MapContainer_clicked (marker) {
  ...
  com.fc.JavaScriptDistLib.Connio.connioReadData('_dev_807652890532634093',
   function(data){
    // Block#: 23
    com.fc.JavaScriptDistLib.Label.setProperty("lbltemperature", "Text", String(convertToText(com.fc.JavaScriptDistLib.Connio.connionGetValue(data, 'mostRecent', 'temperature'))) + String(' C'));// Block#: 30
    com.fc.JavaScriptDistLib.Gauge.setProperty("GaugeTemp", "Current Value", toNumber(com.fc.JavaScriptDistLib.Connio.connionGetValue(data, 'mostRecent', 'temperature'))
    );
  },
   function(error_data){
...
function on_connio_property_updated (device_id,property, value) {
  ...
  if (property == ('temperature')) {
    // Block#: 49
    com.fc.JavaScriptDistLib.Label.setProperty("lbltemperature", "Text", String(value) + String('  °C'));// Block#: 53
    com.fc.JavaScriptDistLib.Gauge.setProperty("GaugeTemp", "Current Value", toNumber(value)
    );}
